<%@ Page Title="" Language="C#" MasterPageFile="~/Web.Master" AutoEventWireup="true" CodeBehind="Yachts_Specification.aspx.cs" Inherits="ProjectTayana.Yachts_Specification" %>
...
<li class="menu_y00">YACHTS</li>
    ...
    <div class="box5">
    <h4>DETAIL SPECTFICATION</h4>
    <asp:Literal ID="ContentHtml" runat="server"></asp:Literal>
        </div>
    <div class="clear"></div>
    <p class="topbuttom"> <img src="tayana/html/images/top.gif" /> </p>
    </div>
</div>
